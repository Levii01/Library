...
ActiveRecord::Schema.define(version: 20170306194616) do
  ...
  create_table "borrow_books", force: :cascade do |t|
    ...
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
    t.index ["book_id"], name: "index_borrow_books_on_book_id", using: :btree
    t.index ["user_id"], name: "index_borrow_books_on_user_id", using: :btree
  end
